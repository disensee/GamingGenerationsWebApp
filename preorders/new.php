...
if(isset($_POST['new']) && $_POST['new'] == "entry")
{
    ...
    $sql = "INSERT INTO orders (order_cust_name, order_phone, order_email, game_id, order_amount, order_store, order_timestamp, employee, order_console) VALUES
            ('".addslashes($_POST['s_cname'])."', '".$phone."', '".$_POST['s_cemail']."', '".$_POST['s_game']."', '".$amount."', '".$x_store."', '".time()."', '".$_POST['s_employee']."', '".$_POST['s_console']."');";
    $db->query($sql);
...
<ul>
<li><label for="Employee">Employee</label><input class="itext" type="text" name="s_employee" id="Employee" value="" /></li>
<li class="iheader">Customer Info</li>
<li><label for="ContactName">Contact Name</label><input class="itext" type="text" name="s_cname" id="ContactName" value="" /></li>
<li><label for="ContactEmail">Contact Email</label><input class="itext" type="text" name="s_cemail" id="ContactEmail" value="" /></li>
<li><label for="ContactPhone">Contact Phone</label><input class="itext" type="text" name="s_phone" id="ContactPhone" value="" /></li>
...
<?
$consoles = array('PS3', 'Wii', 'Xbox 360', 'PSP', "DS", "Switch", "PS4", "Xbox One");
sort($consoles);
for($i=0;$i<count($consoles);$i++)
{
    echo '<option value="'.$consoles[$i].'">'.$consoles[$i].'</option>';
}
?>
</select>
</li>
<li><label for="Deposit">Deposit Amount</label><input class="itext" type="text" name="s_deposit" id="Deposit" value="" onblur="if(this.value < 5) { alert('The customer must put a minimum of $5 down towards the pre-order.'); setTimeout(setFocus, 100); }" /></li>
